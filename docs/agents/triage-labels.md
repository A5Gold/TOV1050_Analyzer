...
roles to the label strings used by this repository's issue tracker.
...
When a skill names a canonical role, use the corresponding tracker label from
this table. Edit the tracker-label column if the repository's vocabulary
changes.
